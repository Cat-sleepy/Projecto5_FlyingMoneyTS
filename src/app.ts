...
import { adicionarTransacao, removerTransacao, type Transacao } from "./modules/transactions.js";
...
// 4) Quando adiciona
onSubmitTransacao((formData: SubmitData) => {
